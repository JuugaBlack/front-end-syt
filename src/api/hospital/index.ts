...
//预约挂号数据接口
export const reqHospitalBooking = (page: number, limit: number, hoscode: string, depcode: string) => request.get<any, HospitalWordData>(API.BOOKING_URL + `${page}/${limit}/${hoscode}/${depcode}`)
...
//获取挂号医生的信息
export const reqGetDoctor = (scheduleId:string) =>request.get<any,DoctorInfoData>(API.GETDOCTOR_URL+scheduleId)