<template>
    <div class="tip">
        ...
        <div class="deparment">
            <div class="header">
                <div class="left">
                    <svg t="1716966876048" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="2639" width="16" height="16">
                        <path
                            ...
                            p-id="2640" fill="#707070"></path>
                    </svg>
                    <span>常见科室</span>
                </div>
                <div class="right">
                    <span>全部</span>
                    <svg t="1716966956808" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="4732" width="16" height="16">
                        <path
        ...
        <div class="notice">
            <div class="header">
                <div class="left">
                    <svg t="1716967685279" class="icon" viewBox="0 0 1026 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="6868" width="16" height="16">
                        <path
        ...
        <div class="close">
            <div class="header">
                <div class="left">
                    <svg t="1716968284162" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="9082" width="16" height="16">
                        <path
