            ...
            <div class="bottom">
                ...
                <div class="right">
                    <el-card style="max-width: 100%" class="card">
                        ...
                        <p>1.请确认就诊人信息是否准确，若填写错误将无法就诊，损失由本人承担；</p>
                        <p>2.可以预约一周内的号源，即本周五可以预约下一周全部工作日的号源；</p>
                        <p>3.【取号】就诊当天上午号需要在10:30点前取号，下午号需要在16:00前取号，未取号视为爽约，该号不退不换；</p>
                        <p>4.【退号】未就诊可以提前一天取消预约；就诊当天未取号可以在窗口取消预约；已取号凭挂号单在窗口办理退号退费，逾期将不可办理退号退费；</p>
                        <p>5．3个月内连续3次预约后不就诊也不取消预约将被限制无法再次预约。</p>
                    </el-card>
                </div>
            </div>
        </el-card>
        <!-- 支付二维码 通过v-model控制显示与隐藏-->
        <el-dialog v-model="dialogVisible" @close="close" title="微信支付" width="400">
            <!-- 二维码 -->
            <div class="qrocode">
                <img :src="imgUrl" alt="">
                <p>请使用微信扫一扫</p>
